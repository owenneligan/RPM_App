        ...
        >
          ...
          <form onSubmit={handleEmailSignIn} className="flex flex-col gap-3">
            ...
            <div className="relative">
              <Mail
                ...
                style={{
                  ...
                  color: '#9EA3A8', pointerEvents: 'none',
                }}
              />
              <input
                type="email"
            ...
            <div className="relative">
              ...
              <button
                ...
                style={{
                  ...
                  color: '#9EA3A8', cursor: 'pointer', padding: 0,
                }}
              >
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (!loading) (e.currentTarget as HTMLElement).style.background = '#1F3A6B'
              }}
              onMouseLeave={(e) => {
                if (!loading) (e.currentTarget as HTMLElement).style.background = '#2B4C7E'
              }}
            >
